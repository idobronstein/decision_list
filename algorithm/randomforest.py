...
def run_once(train_set_size, test_set_size, result_path):
	# create working dir
	run_title = 'RandomForest_N={0}_K={1}_D={2}'.format(N, K, D, train_set_size, test_set_size)
	...
	# Run random forest
	clf = RandomForestClassifier(n_estimators=100, max_depth=D * 2, random_state=0)
